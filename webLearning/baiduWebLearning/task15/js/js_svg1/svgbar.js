...
function svgBar(){
	...
	for(i=0;i<data.length;i++){
		...
		brect.setAttribute("height",dataSource[i]*0.3);
		brect.setAttribute("x",40*i+40);
		brect.setAttribute("y",(dataMax-dataSource[i])*0.3+163);
	...
	var axis=document.createElementNS("http://www.w3.org/2000/svg","polyline");
		axis.setAttribute("points","25 5,30 0,35 5,30 0,30 245,560 245,555 240,560 245,555 250");
